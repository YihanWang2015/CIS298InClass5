  ...
  //  private static final String API_KEY = "YourApiKeyHere";
    ...
    public List<Crime> fetchCrimes(){
       ...
       List<Crime> crimes = new ArrayList<>();
        ...
        try {
            ...
            //This calls the above methods to use the URL to get the JSON from the web service.
            //After this call we will actually have the JSON that we need to parse.
            String jsonString = getUrlString(url);

            //This will take the jsonString that we got back and put it into a jsonArray object.
            //We have to use a jsonArray because our jsonString starts out with an Array.
            //If it started with an Object "{}", we would need to use JSONObject instead of JSONArray.
            //The book uses JSONObject for their parse.
            JSONArray jsonArray = new JSONArray(jsonString);


            //Call the parseCrimes method that is defined below. Send in the crimes list that was
            // created at the top of this method.
            // Also send in the jsonArray that was created in the previous statement.
            // Since the List that was sent in was declared in this method, and is and object,
            // it will be automatically passed by reference.
            //Once the parseCrimes method completes the crimes list variable that was passed
    ...
    private void parseCrimes(List<Crime> crimes, JSONArray jsonArray)
        ...
        for (int i = 0; i<jsonArray.length(); i++){
            ...
            //Fetch a single JSONObject out from the JSONArray based on the current index that we are on.
            ...
            //Set the title on the crime by retrieving it from the JSONObject.
            ...
            //equal to "1". If the expression is true, then the is_solved property of the crime will
            //be true. Else false.
            crime.setSolved(crimeJsonObject.getString("is_solved").equals("1"));

            //Add the finished crime to the list of crimes that was passed in to the method.
            crimes.add(crime);
        }
